module QME
  module Importer
    ...
    #
    # This class is a Singleton. It should be accessed by calling PatientImporterC32.instance
    class PatientImporterC32

      include Singleton

      # Creates a new PatientImporterC32 with the following XPath expressions used to find content in 
      # a HITSP C32:
      #
      # Encounter entries
